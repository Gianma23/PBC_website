        ...
        <nav>
            <ul class="footer-nav">
                ...
                <li class="footer-nav__list">Contatti
                    <ul>
                            <li class="footer-nav__list__item">Telefono: <a href="#">+0586 123942</a></li>
                            <li class="footer-nav__list__item">E-mail: <a href="#">info@piccolobirrificioclandestino.it</a></li>
                            <li class="footer-nav__list__item">Indirizzo:<a href="#">Via Cimarosa </a></li>
